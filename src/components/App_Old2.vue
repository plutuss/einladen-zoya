...
<template>
  <div class="relative min-h-screen overflow-hidden bg-gradient-to-br from-rose-100 via-pink-100 to-purple-100 px-3 py-5 sm:px-4 sm:py-8">
        ...
        <div class="relative overflow-hidden rounded-[1.75rem] border border-white/70 bg-white/75 p-5 shadow-2xl shadow-pink-200/70 backdrop-blur-xl sm:rounded-[2.5rem] sm:p-8 md:p-10">
          ...
          <template v-if="!showForm && !isSubmitted">
            <div class="relative text-center">
              ...
              <p class="mb-2 text-sm font-semibold uppercase tracking-[0.22em] text-pink-500 sm:text-base">
                маленьке запрошення
              </p>
              ...
              <p class="mx-auto mb-8 max-w-md text-lg leading-8 text-gray-700 sm:text-xl">
              ...
              <div class="relative mt-8 flex flex-col items-center justify-center gap-4 sm:flex-row">
                <button
                    @click="acceptInvite"
                    class="group relative min-h-16 w-full overflow-hidden rounded-3xl bg-gradient-to-r from-pink-500 via-rose-500 to-fuchsia-500 px-10 py-5 text-lg font-bold text-white shadow-xl shadow-pink-300/70 transition duration-300 hover:-translate-y-1 hover:scale-105 hover:shadow-2xl active:scale-95 sm:w-auto sm:min-w-44"
                >
                ...
                <button
                    ...
                    :style="isNoButtonEscaped ? noButtonStyle : {}"
                    class="min-h-16 w-full rounded-3xl border border-pink-100 bg-white/95 px-8 py-5 text-base font-bold text-gray-700 shadow-xl shadow-pink-100/80 ring-1 ring-white/80 transition duration-300 hover:-translate-y-1 hover:bg-white active:scale-95 sm:w-auto sm:min-w-56 sm:text-lg"
                >
                  Ні, я поки соромлюся 🙈
                </button>
              </div>
          ...
          <template v-else-if="showForm && !isSubmitted">
            <div class="relative">
              ...
              <div class="space-y-5">
                <div>
                  <label class="mb-2 block text-base font-bold text-gray-700">
                    📅 Дата
                  </label>
                  <input
                ...
                <div>
                  <label class="mb-3 block text-base font-bold text-gray-700">
                    ✨ Що обираєш?
                  </label>
                  ...
                  <div class="grid gap-3">
                    <button
                        ...
                        class="rounded-2xl border p-4 text-left transition duration-300 hover:-translate-y-0.5 hover:shadow-md sm:p-5"
          ...
          <template v-else>
            <div class="relative text-center">
              ...
              <p class="mt-6 text-base font-semibold text-pink-500">
                До зустрічі 🌹
              </p>
            </div>
          </template>
